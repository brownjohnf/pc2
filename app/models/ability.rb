class Ability
  ...
  def initialize(user)
    alias_action :updated, :added, :download, :search, :feed, :to => :read
    ...
    can :read, [ Page, CaseStudy, Photo, Website, Blog, Library, Moment, Pcregion, Position, Sector, Staff, Stage, Stack ]
