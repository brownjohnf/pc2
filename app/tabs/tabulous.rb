...
Tabulous.setup do |config|
  ...
  config.tabs do
    [
      ...
      [    :documents_tab        ,    'Documents'        ,    documents_path         ,    true        ,    true        ],
      [    :feed_subtab         ,     'Recently updated' ,    documents_path         ,    true        ,    true],
      [    :case_studies_tab     ,    'Case Studies'     ,    case_studies_path      ,    true        ,    true        ],
      [    :imports_tab          ,    'Imports'          ,    imports_path           ,    true        ,    true        ],
      [    :languages_tab        ,    'Languages'        ,    languages_path         ,    true        ,    true        ],
      [    :libraries_tab        ,    'Libraries'        ,    libraries_path         ,    true        ,    true        ],
      [    :stacks_tab           ,    'Stacks'           ,    stacks_path            ,    true        ,    true        ],
      [    :photos_tab           ,    'Photos'           ,    photos_path            ,    true        ,    true        ],
      [    :moments_tab          ,    'Moments'          ,    moments_path           ,    true        ,    true        ],
      [    :sites_tab            ,    'Sites'            ,    sites_path             ,    true        ,    true        ],
      [    :sectors_tab          ,    'Sectors'          ,    sectors_path           ,    true        ,    true        ],
      [    :positions_tab        ,    'Positions'        ,    positions_path         ,    true        ,    true        ],
      [    :jobs_tab             ,    'Jobs'             ,    jobs_path              ,    true        ,    true        ],
      [    :staff_tab            ,    'Staff'            ,    staff_index_path       ,    true        ,    true        ],
      [    :websites_tab         ,    'Websites'         ,    websites_path          ,    true        ,    true        ],
      [    :identities_tab       ,    'Identities'       ,    identities_path        ,    true        ,    true        ],
      [    :stages_tab           ,    'Stages'           ,    stages_path            ,    true        ,    true        ],
      [    :scopes_tab           ,    'Scopes'           ,    scopes_path            ,    true        ,    true        ],
      [    :regiontypes_tab      ,    'Regiontypes'      ,    regiontypes_path       ,    true        ,    true        ],
      [    :pcregions_tab        ,    'Pcregions'        ,    pcregions_path         ,    true        ,    true        ],
      [    :regions_tab          ,    'Regions'          ,    regions_path           ,    true        ,    true        ],
      [    :volunteers_tab       ,    'Volunteers'       ,    volunteers_path        ,    true        ,    true        ],
      [    :settings_tab         ,    'Settings'         ,    settings_path          ,    true        ,    true        ],
      [    :blogs_tab            ,    'Blogs'            ,    blogs_path             ,    true        ,    true        ],
      [    :feedback_tab         ,    'Feedback'         ,    feedback_index_path    ,    true        ,    true        ],
      [    :contributions_tab    ,    'Contributions'    ,    contributions_path     ,    true        ,    true        ],
  ...
  config.actions do
    [
      ...
      [    :documents        ,    :all_actions    ,    :documents_tab        ],
      [    :case_studies     ,    :all_actions    ,    :case_studies_tab     ],
      [    :imports          ,    :all_actions    ,    :imports_tab          ],
      [    :languages        ,    :all_actions    ,    :languages_tab        ],
      [    :libraries        ,    :all_actions    ,    :libraries_tab        ],
      [    :stacks           ,    :all_actions    ,    :stacks_tab           ],
      [    :photos           ,    :all_actions    ,    :photos_tab           ],
      [    :moments          ,    :all_actions    ,    :moments_tab          ],
      [    :sites            ,    :all_actions    ,    :sites_tab            ],
      [    :sectors          ,    :all_actions    ,    :sectors_tab          ],
      [    :positions        ,    :all_actions    ,    :positions_tab        ],
      [    :jobs             ,    :all_actions    ,    :jobs_tab             ],
      [    :staff            ,    :all_actions    ,    :staff_tab            ],
      [    :websites         ,    :all_actions    ,    :websites_tab         ],
      [    :identities       ,    :all_actions    ,    :identities_tab       ],
      [    :stages           ,    :all_actions    ,    :stages_tab           ],
      [    :scopes           ,    :all_actions    ,    :scopes_tab           ],
      [    :regiontypes      ,    :all_actions    ,    :regiontypes_tab      ],
      [    :pcregions        ,    :all_actions    ,    :pcregions_tab        ],
      [    :regions          ,    :all_actions    ,    :regions_tab          ],
      [    :volunteers       ,    :all_actions    ,    :volunteers_tab       ],
      [    :settings         ,    :all_actions    ,    :settings_tab         ],
      [    :blogs            ,    :all_actions    ,    :blogs_tab            ],
      [    :feedback         ,    :all_actions    ,    :feedback_tab         ],
      [    :contributions    ,    :all_actions    ,    :contributions_tab    ],
