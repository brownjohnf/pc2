module DocumentsHelper
  ...
  def document_icon_for(document, options = { :size => :icon })
    ...
    link_to image_tag("icons/filetypes/#{icons[document.file_content_type] ? icons[document.file_content_type] : 'extras/filetype_blank.png'}", :width => sizes[options[:size]], :style => 'box-shadow: none;'), document, :class => 'avatar'
  end
