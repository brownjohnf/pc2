  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved site_config as @site_config" do
        ...
        post :create, {:site_config => {}}, valid_session
        assigns(:site_config).should be_a_new(SiteConfig)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested site_config" do
        ...
        SiteConfig.any_instance.should_receive(:update_attributes).with({'these' => 'params'})
        put :update, {:id => site_config.to_param, :site_config => {'these' => 'params'}}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the site_config as @site_config" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        SiteConfig.any_instance.stub(:save).and_return(false)
        put :update, {:id => site_config.to_param, :site_config => {}}, valid_session
        assigns(:site_config).should eq(site_config)
      end
